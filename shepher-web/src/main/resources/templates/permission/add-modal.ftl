        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">
                    添加授权 <span id="grant-permission"></span>
                </h4>
            </div>
                ...
                <div class="modal-body">
                    <fieldset>
                        <div class="form-group">
                            <label for="cluster" class="col-lg-2 control-label">授权集群</label>
                            <div class="col-lg-8">
                        ...
                        <div class="form-group">
                            <label for="path" class="col-lg-2 control-label">授权目录</label>
                            <div class="col-lg-8 ">
                        ...
                        <div class="form-group">
                            <label for="team" class="col-lg-2 control-label">授权小组</label>
                            <div class="col-lg-8">
